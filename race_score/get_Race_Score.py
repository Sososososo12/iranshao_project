...
def get_comment_list(url_response):
    ...
    user_comment_list = selctor.xpath('//ol[@id="race_comment_tab"]/li')
    user_comment_len = len(user_comment_list)
...
def get_comment_dinfo(comments_list):
    comments_all = []
    for user in comments_list:
